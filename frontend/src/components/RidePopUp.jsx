      ...
      <div className="flex gap-2 justify-between flex-col items-center">
        ...
        <div className="flex mt-5 w-full items-center justify-between">
          <button
            ...
            className="w-full mt-1 bg-gray-300 text-white font-semibold p-3 px-10 rounded-lg"
          >
            Ignore
          </button>
          <button
            ...
            className="w-full mt-5 bg-green-600 text-white font-semibold p-3 px-10 rounded-lg"
          >
            Accept
          </button>
        </div>
